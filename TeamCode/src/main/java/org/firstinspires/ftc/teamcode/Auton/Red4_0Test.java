 ...
 */
@Config
@Autonomous(name = "4+0Test", group = "Examples")
public class Red4_0Test extends OpMode {

    private Follower follower;
    private Timer pathTimer, actionTimer, opmodeTimer;
    public static int armOuttakePos=1047;
    public static int slideOuttakePos=1488;
    public static double wristOuttakePos=.225;
    ...
    private double gClose=.9;
    private double gOpen = 0;
...
//    private final Pose startPose = new Pose(7, 63, Math.toRadians(0));
    ...
    private final Pose scorePose1 = new Pose(28, 0, Math.toRadians(0));

    /** Lowest (First) Sample from the Spike Mark */
    private final Pose swipeSample1 = new Pose(28, -30, Math.toRadians(310));

    private final Pose swipeSample2 = new Pose(28, -34, Math.toRadians(310));

    private final Pose dropSample = new Pose(21, -34, Math.toRadians(230));

    private final Pose pickup1Pose = new Pose(15, -40, Math.toRadians(180));
    private final Pose scorePose2 = new Pose(28, 6, Math.toRadians(0));
    private final Pose scorePose3 = new Pose(27, 6, Math.toRadians(0));
    private final Pose scorePose4 = new Pose(27, 9, Math.toRadians(0));
...
//    private final Pose pickup3Pose = new Pose(49, 135, Math.toRadians(0));
    ...
    private final Pose parkPose = new Pose(7, -35, Math.toRadians(0));
    ...
    private PathChain swipePos, swipeSample_1,score1Pickup1, dropSample1, swipeSample_2,dropSample2,grabPickup1,grabPickup2,grabPickup3,  scorePickup1, scorePickup2, scorePickup3;
    ...
    public void buildPaths() {
        ...
        score1Pickup1 = follower.pathBuilder()
        ...
        park = new Path(new BezierLine(new Point(scorePose2), new Point(parkPose)));
            ...
            case 1:
                ...
                */
                ...
                if(follower.getPose().getX() > (scorePose1.getX() - 1) && follower.getPose().getY() > (scorePose1.getY() - 1)
                        &&Math.abs(arm.getTargetPosition()-arm.getCurrentPosition())<=10
                        &&Math.abs(slide.getTargetPosition()-slide.getCurrentPosition())<=10) {
                    /* Score Preload */
//                    robot.scoringClaw();
//                    robot.openClaw();
...
//                    follower.followPath(swipeSample_1,true);
            ...
            case 102:
                if(Math.abs(arm.getTargetPosition()-arm.getCurrentPosition())<=10){
                    ...
                    slide.setPower(.4);
                    slide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    follower.followPath(score1Pickup1,true);
                    setPathState(2);
                }
                break;
            case 2:
...
//                    follower.followPath(scorePickup1,true);
    ...
    public void init() {
        ...
        gripper=hardwareMap.get(Servo.class,"OuttakeGripper");
